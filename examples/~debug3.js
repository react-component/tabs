...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rc_tabs_lib_InkTabBar__ = __webpack_require__(128);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Demo = function (_React$Component) {
  ...
  function Demo() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref2 = Demo.__proto__ || Object.getPrototypeOf(Demo)).call.apply(_ref2, [this].concat(args))), _this), _this.state = {
      tabsData: [{ tab: "tab1", content: "tab1 content" }, { tab: "tab2", content: "tab2 content" }]
    }, _this.handleRemoveTabsChild = function () {
      _this.setState({ tabsData: [] });
      // 模拟网络请求
      setTimeout(function () {
        _this.setState({
          tabsData: [{ tab: "tab1", content: "tab1 content" }, { tab: "tab2", content: "tab2 content" }]
    ...
    value: function render() {
      ...
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
          'button',
          { onClick: this.handleRemoveTabsChild },
          '\u5237\u65B0'
        ),
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_4_rc_tabs__["b" /* default */],
          {
            ...
            renderTabBar: function renderTabBar() {
              return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6_rc_tabs_lib_InkTabBar__["a" /* default */], {
                onTabClick: _this2.onTabClick,
                tabBarGutter: 40
              });
            },
            renderTabContent: function renderTabContent() {
              return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5_rc_tabs_lib_SwipeableTabContent__["a" /* default */], null);
            },
            onChange: this.onChange
          },
          this.state.tabsData.map(function (_ref3) {
            var tab = _ref3.tab,
